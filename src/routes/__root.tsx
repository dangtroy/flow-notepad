  ...
  head: () => ({
    meta: [
      ...
      { title: "Flow — one continuous stream of your thoughts" },
      {
        name: "description",
        content:
          "Flow is one permanent conversation with yourself: send a thought, it's saved forever and organized quietly in the background.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,400..700&family=Karla:wght@400;500;600&display=swap",
      },
